    ...
    var $backgrounds = $( "<ul class='sm-slider'></ul>" ),
        ...
        mkcss: function( bgCount , duration , fade  ) 
        {
            ...
            for(var i=0;i<bgCount;i++)
            {
                ...
                css += "@media screen and (max-width:767px){.sm-slider li:nth-child({0}) span { background-image: url('{1}');}}".format(i+1 , smpBg.url);
            }
