...
<div id="wrapper">
	<header>
		<nav>
			<ul>
				<li><a data-role="anchor" href="#event">イベント情報</a></li>
				<li><a data-role="anchor" href="#articsts">参加アーティスト</a></li>
				<li><a data-role="anchor" href="#access">アクセス</a></li>
				<li><a data-role="anchor" href="#about">シマダカラ芸術祭とは</a></li>
				<li><a data-role="anchor" href="#place">開催概要</a></li>
			</ul>
		</nav>
		<div class="cont">
			<div class="back"><a href="#" data-role="pageTop">はじめにもどる</a></div>

			<ul>
				<li><a href="#"><img width="21" src="<?php get_template_directory_uri(); ?>/img/icon_fb.svg" alt=""></a></li>
				<li><a href="#"><img width="21" src="<?php get_template_directory_uri(); ?>/img/icon_insta.svg" alt=""></a></li>
			</ul>
		</div>
	</header>
